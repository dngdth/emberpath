        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wider ${wsStatus === 'connected'
              ...
              >
                <span
                  className={`h-1.5 w-1.5 rounded-full ${wsStatus === 'connected'
          ...
          {activeTab === 'dashboard' ? (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                {/* Card 1: Floors */}
                <div
                  className={`rounded-2xl border p-5 flex items-center gap-4 transition-all duration-300 ${isDark ? 'bg-[#1E293B] border-slate-800' : 'bg-white border-slate-200'
                    }`}
                >
                  <div
                    className={`p-3.5 rounded-xl ${isDark ? 'bg-blue-500/10 text-blue-400' : 'bg-blue-600/10 text-blue-600'
                      }`}
                  >
                    <Layers size={22} />
                  </div>
                ...
                >
                  <div
                    className={`p-3.5 rounded-xl ${isDark ? 'bg-indigo-500/10 text-indigo-400' : 'bg-indigo-700/10 text-indigo-700'
                      }`}
                  >
                ...
                >
                  <div
                    className={`p-3.5 rounded-xl ${summary?.danger_count && summary.danger_count > 0
                ...
                >
                  <div
                    className={`p-3.5 rounded-xl ${activeAlertsCount > 0
                  ...
                  <div className="flex-1">
                    ...
                    <span
                      className={`text-3xl font-extrabold font-mono tracking-tight ${activeAlertsCount > 0 ? 'text-rose-500' : ''
                        }`}
                    >
              ...
              <div
                className={`rounded-3xl border shadow-soft p-5 transition-colors duration-300 ${isDark ? 'bg-[#1E293B] border-slate-800' : 'bg-white border-slate-200'
                  }`}
              >
                ...
                {loadingPlan ? (
                  <div
                    className={`h-[520px] rounded-2xl border border-dashed flex flex-col items-center justify-center gap-2 ${isDark ? 'border-slate-800 text-slate-400 bg-slate-950/20' : 'border-slate-200 text-slate-500 bg-slate-50'
                      }`}
                  >
              ...
              <div
                className={`rounded-3xl border shadow-soft overflow-hidden transition-colors duration-300 ${isDark ? 'bg-[#1E293B] border-slate-800' : 'bg-white border-slate-200'
                  }`}
              >
                <div className="flex flex-wrap items-center justify-between border-b px-6 py-4 transition-colors duration-300 border-inherit">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-64 pl-9 pr-4 py-1.5 text-xs rounded-xl border outline-none transition duration-200 ${isDark
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr
                        className={`text-[10px] font-bold uppercase tracking-wider border-b transition-colors duration-300 ${isDark
                    ...
                    <tbody
                      className={`divide-y text-xs transition-colors duration-300 ${isDark ? 'divide-slate-800' : 'divide-slate-200/80'
                        }`}
                    >
                      {loading ? (
                        <tr>
                        ...
                        allSensors.map((sensor) => {
                          ...
                          return (
                            <tr
                              key={sensor.id}
                              className={`transition-colors hover:bg-slate-500/5 ${isDanger
                            ...
                            >
                              ...
                              <td className="py-3 px-6 text-center">
                                <span
                                  className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold tracking-wider ${isDanger
                              ...
                              <td className="py-3 px-6 text-center">
                                <button
                                  ...
                                  className={`px-3 py-1 rounded-lg text-[10px] font-bold uppercase transition ${isDark
            ...
            <div
              className={`rounded-3xl border shadow-soft p-6 transition-colors duration-300 ${isDark ? 'bg-[#1E293B] border-slate-800' : 'bg-white border-slate-200'
                }`}
            >
              <div className="flex flex-wrap items-center justify-between border-b pb-4 mb-4 border-inherit">
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => refresh()}
                    className={`flex items-center gap-2 px-3 py-1.5 text-xs font-semibold rounded-lg border transition ${isDark
                    ...
                    {[
                      ...
                      >
                        ...
                        <td className="py-3.5 px-6 text-center">
                          <span
                            className={`inline-block px-2.5 py-0.5 rounded-full text-[9px] font-bold ${item.st === 'danger'
