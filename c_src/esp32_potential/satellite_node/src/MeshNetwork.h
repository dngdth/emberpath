...
public:
    ...
    bool init();
    void sendSensorData(float temp, int gas, bool emergency, float totalPotential);
    void broadcastPotential(float totalPotential);
...
private:
    ...
    void triggerFailover(const uint8_t *failedMac);
